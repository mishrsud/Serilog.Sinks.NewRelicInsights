...
var solutionPath = "./src/Serilog.Sinks.NewRelicInsights.sln";
...
Task("Pack")
    ...
    .Does(() => 
    {
        ...
        DotNetCorePack("./src/Serilog.Sinks.NewRelicInsights/Serilog.Sinks.NewRelicInsights.csproj", settings);
    });
